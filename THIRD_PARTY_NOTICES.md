...
NOTICE (from the rust_gbm distribution):

    rust_gbm
    Copyright 2026 Lowdown Labs

    This product includes software developed at Lowdown Labs.
...
safetensors is distributed under the Apache License, Version 2.0. The safetensors
distribution does not include a separate NOTICE file, so none is reproduced here.

--------------------------------------------------------------------------------

## Apache License, Version 2.0

The full text below applies to rust_gbm and safetensors as noted above.
