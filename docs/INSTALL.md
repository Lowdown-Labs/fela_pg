...
```bash
docker run --rm -e POSTGRES_PASSWORD=postgres -p 5432:5432 ghcr.io/lowdown-labs/fela_pg:pg18
# in another terminal:
...
[GitHub Releases page](https://github.com/Lowdown-Labs/fela_pg/releases), then install it with your
